...
// 			$js_array[]="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js";
// 			$js_array[]="https://cdn.datatables.net/r/dt/jq-2.1.4,jszip-2.5.0,pdfmake-0.1.18,dt-1.10.9,af-2.0.0,b-1.0.3,b-colvis-1.0.3,b-html5-1.0.3,b-print-1.0.3,se-1.0.1/datatables.min.js";
            if($page=='ecash_request' || $page=='requeststatus' )
            {
