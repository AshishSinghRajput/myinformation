                            ...
                            <div id="collapseTwo-6" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;"> 
                                <div class="panel-body">
                                   ...
                                   <tr>
                                       ...
                                       <tr>
                                          <td><?php echo $education->tenth_class_name; ?></td>
                                          <?php if(isset($education))
                                          { 
                                            $img10 = unserialize($education->tenth_class_certificate_img);
                                          }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/education/school/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                          <td><?php echo $education->tenth_class_passing_year; ?></td>
                                          <td><?php echo $education->tenth_class_school_name; ?></td>
                                          <td><?php echo $education->tenth_board_name; ?></td>
                                          <td><?php echo $education->tenth_percentage; ?></td> 
                                       </tr>
                                       <tr>
                                          <td><?php echo $education->twelfth_class_name; ?></td>
                                          <?php if(isset($education))
                                          { 
                                            $img10 = unserialize($education->twelfth_class_certificate_img);
                                          }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/education/school/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                          <td><?php echo $education->twelfth_class_passing_year; ?></td>
                                          <td><?php echo $education->twelfth_class_school_name; ?></td>
                                          <td><?php echo $education->twelfth_board_name; ?></td>
                                          <td><?php echo $education->twelfth_percentage; ?></td> 
                                       </tr>
                                       <tr>
                                          <td><?php echo $education->graduation_name; ?></td>
                                          <?php if(isset($education))
                                          { 
                                            $img10 = unserialize($education->graduation_certificate_img);
                                          }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/education/school/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                          <td><?php echo $education->graduation_passing_year; ?></td>
                                          <td><?php echo $education->graduation_collage_name; ?></td>
                                          <td><?php echo $education->graduation_university; ?></td>
                                          <td><?php echo $education->graduation_percentage; ?></td> 
                                       </tr>
                                       <tr>
                                          <td><?php echo $education->postgraduation_name; ?></td>
                                          <?php if(isset($education))
                                          { 
                                            $img10 = unserialize($education->postgraduation_certificate_img);
                                          }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/education/school/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                          <td><?php echo $education->postgraduation_passing_year; ?></td>
                                          <td><?php echo $education->postgraduation_collage_name	; ?></td>
                                          <td><?php echo $education->postgraduation_university; ?></td>
                                          <td><?php echo $education->postgraduation_percentage; ?></td> 
                                       </tr>
                                       <tr>
                                          <td><?php echo $education->other_education_name; ?></td>
                                          <?php if(isset($education))
                                          { 
                                            $img10 = unserialize($education->other_education_certificate_img);
                                          }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/education/school/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                          <td><?php echo $education->other_education_passing_year; ?></td>
                                          <td><?php echo $education->other_education_collage	; ?></td>
                                          <td><?php echo $education->other_education_university; ?></td>
                                          <td><?php echo $education->other_education_percentage; ?></td> 
                                       </tr>
                                ...
                                <div class="panel-body">
                                   ...
                                   <table class="table table-striped">
                                        <tr>
                                            ...
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->father_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                              </p></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->mother_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                            </p></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My grandfather's name Photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->grandfather_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My grandmother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->grandmother_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great-grandfather's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->great_grandfather_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great-grandmother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->great_grandmother_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->great_grandfather_father_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->great_grandmother_mother_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->father5_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->mother5_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's father's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->father6_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's father's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->mother6_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's father's father's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->father7_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My great grandfather's father's father's father's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->mother7_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->my_mother_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            <td><p><b>My father's name: </b><?= $geration->my_father;?></p></td>
                                            <td><p><b>My father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->my_father_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandfather's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandfather_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_granfather_f_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_1);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_f_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_m_m_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_m_f_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's mother's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_m_m_m_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's mother's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_m_m_f_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's mother's mother's mother's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_m_m_m_m_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><p><b>My maternal grandmother's mother's mother's mother's mother's father's name photo: </b>
                                            <?php if(isset($geration))
                                            { 
                                                $img10 = unserialize($geration->maternal_grandmother_m_m_m_m_f_img);
                                            }
                                            ?>
                                          <td> <img src="<?=base_url('uploads/generation/') . $img10[0];?>" name="" height="70" width="116" style="margin-top: 10px;"></td>
