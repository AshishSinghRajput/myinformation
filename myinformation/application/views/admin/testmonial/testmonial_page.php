				...
				?>
					...
					<div class='col-lg-4'>
						<div class="form-group">
							...
							<input type="file"  name="img[]" id="img" accept="image/*" class="form-control" value="" required>
							...
							<table class="table m-0">
								...
								<tbody>
								  ...
								  <tr>
									...
									<td>
										<a href="<?php echo site_url('admin/delete_testmonial?id='.base64_encode($row->id)); ?>" onclick="return confirm('Are you sure delete')" class="pr-10" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></a>
									</td>
								  </tr>
								  <?php } ?>
								</tbody>
