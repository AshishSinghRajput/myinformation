    ...
    <div class="row">
         <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Pending User's Information</b></h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                    ...
                    <tr> 
                        ...
                        <td><?= $data->mobile; ?></td>
                        <td><a onclick="return confirm('Are you sure to block user')" class="btn btn-sm btn-success" href="<?= base_url('block')?>/<?= $row->sponsor_id; ?>">Block</a></td>
                    </tr>
                <?php } } ?>
                    </tbody>
                </table>
