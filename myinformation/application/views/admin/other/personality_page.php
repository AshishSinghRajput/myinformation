...
<div class="row">
	...
	<div class="col-sm-12">
		...
		<div class="card-box table-responsive">
			<h4 class="m-t-0 header-title"><b>Now Towards A Fantastic Personality</b></h4>			
				...
				?>
					<div class='col-lg-6'>
						<div class="form-group">
							...
							<input type="text"  name="client_name"  class="form-control" value="" placeholder="Enter Full Name">
					...
					<div class='col-lg-6'>
						<div class="form-group">
							...
							<input type="text"  name="position"  class="form-control" value="" placeholder="Enter Company Position">
